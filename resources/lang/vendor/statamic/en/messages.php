...
return [
    ...
    'cache_utility_application_cache_description' => 'Laravel\'s unified cache used by Eklektos, third party addons, and composer packages.',
    'cache_utility_description' => 'Manage and view important information about Eklektos\'s various caching layers.',
    'cache_utility_image_cache_description' => 'The image cache stores copies of all transformed and resized images.',
    'cache_utility_stache_description' => 'The Stache is Eklektos\'s content store that functions much like a database. It is generated automatically from the content files.',
    'cache_utility_static_cache_description' => 'Static pages bypass Eklektos completely and are rendered directly from the server for maximum performance.',
    ...
    'collections_amp_instructions' => 'Enable Accelerated Mobile Pages (AMP). Automatically adds routes and URL for entries in this collection. Learn more in the [documentation](https://Eklektos.dev/amp)',
    ...
    'collections_mount_instructions' => 'Choose an entry on which this collection should be mounted. Learn more in the [documentation](https://Eklektos.dev/collections-and-entries#mounting).',
    ...
    'getting_started_widget_docs' => 'Get to know Eklektos by understanding its capabilities the right way.',
    'getting_started_widget_header' => 'Getting Started with Eklektos',
    'getting_started_widget_intro' => 'To begin building your new Eklektos site, we recommend starting with these steps.',
    'getting_started_widget_navigation' => 'Create multi-level lists of links that can be used to render navbars, footers, and so on.',
    'getting_started_widget_pro' => 'Eklektos Pro adds unlimited user accounts, roles, permissions, git-integration, revisions, multi-site, and more!',
    'git_disabled' => 'Eklektos Git integration is currently disabled.',
    ...
    'licensing_sync_instructions' => 'Data from Eklektos.com is synced once per hour. Force a sync to see any changes you\'ve made.',
    ...
    'outpost_error_422' => 'Error communicating with Eklektos.com.',
    'outpost_error_429' => 'Too many requests to Eklektos.com.',
    'outpost_issue_try_later' => 'There was an issue communicating with Eklektos.com. Please try again later.',
    ...
    'search_utility_description' => 'Manage and view important information about Eklektos\'s search indexes.',
    ...
    'user_wizard_invitation_body' => 'Activate your new Eklektos account on :site to begin managing this website. For your security, the link below expires after :expiry hour. After that, please contact the site administrator for a new password.',
    ...
    'user_wizard_invitation_subject' => 'Activate your new Eklektos account on :site',
